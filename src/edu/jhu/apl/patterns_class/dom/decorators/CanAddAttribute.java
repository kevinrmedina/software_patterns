...
public class CanAddAttribute extends DOMSourceDecorator{


    public CanAddAttribute(DOMSource source, Node dom, String text) {
        super(source, dom, text);
    }
    public CanAddAttribute(Node dom, String text) {
        super(dom, text);
    }
